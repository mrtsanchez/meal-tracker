...
@Component ({
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          <input [(ngModel)]="caloriesGoal" class="form-control input-lg" id="calories-goal">
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="well" id="countCalories"><p>Total calories for these meals: {{totalCalories(childMealList| calories:selectedCalories | date:selectedDate)}}.</p>
...
export class MealListComponent {
  ...
  public caloriesGoal: number = 100;
